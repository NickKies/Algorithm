 ...
 */
public class Q17_longestPrefixLength {
    public static void main(String[] args) {
    String[] input1 = {"apple", "apps", "ape"};
    String[] input2 = {"hawaii", "happy"};
    String[] input3 = {"dog", "dogs", "doge"};

    System.out.println(longestPrefixLength(input1));
    System.out.println(longestPrefixLength(input2));
    System.out.println(longestPrefixLength(input3));
